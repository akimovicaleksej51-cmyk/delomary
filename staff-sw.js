// Minimal service worker for the staff panel — its ONLY job is to satisfy
...
// icon, not a plain browser bookmark. Mirrors admin-sw.js exactly, just
// scoped to staff.html so the two can be installed side by side as
// separate app icons.
//
...
// the staff panel (bookings, Касса, live balances) must always show
